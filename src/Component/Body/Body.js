      ...
      <div className={bodycss.bb}>
        <div className={bodycss.matn}>
          ...
          <p className={bodycss.tagehp}>
            ...
            از بروز ترین متد ها به بررسی سایت شما میپردازیم و در عرض چند ماه با
            استاندارد های سئو سایت شما رو به رتبه اول گوگل تبدیل میکنیم . نگران
            نباشید اگر کسب و کار خود را اینترنتی نکرده اید ! گروه طراحی سایت اُ
            یک با استفاده از استاندارد های به روز طراحی و برنامه نویسی ۰ تا ۱۰۰
            سایت شمارو با بالاترین سرعت طراحی می‌کنند.
          </p>
        </div>
      ...
      <div className={bodycss.baner}>
        <div className={bodycss.text}>
          ...
          <p>
            ...
            دارید به راه اندازی کسب و کار اینترنتی گروه پشتیبانی اُ یک درخدمت
            شما است تا بهترین راهنمایی را به شما انجام دهد . گروه اُ یک ۰ تا ۱۰۰
            سایت شمارو (پشتیبانی ، طراحی سایت ، سئو سایت ، ui ux سایت و ...)
            انجام می‌دهد و همچنین با داشتن نمونه کار های متعدد باعث رضایت بسیاری
            از مراجعه کنندگان بوده است.
          </p>
        </div>
